...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 08 sep. 2023 à 09:31
...
INSERT INTO `accueil` (`idAccueil`, `accueilTitre`, `accueilText`, `accueilDescription`, `accueilImage`, `accueilButton`) VALUES
(1, 'A propos de nous', '  SANTE ET FORMATION <br>\r\n Investir dans un avenir meilleur', 'Notre Association \"Santé & Formation\" contribue activement à la formation, l’éducation et l’insertion\r\nprofessionnelle des personnes précaires.\r\n Nos activités sont axées sur la santé physique et mentale, l’information et la prévention. ', ' <img src=\"img/pexels-murilo-fonseca-17239050.jpg\" alt=\"\">', '');
...
INSERT INTO `action` (`idAction`, `actionTitre`, `actionDescription`, `actionText`, `actionImages`, `actionDate`, `actionImageText`) VALUES
(1, 'Nos actions', 'Investir dans un avenir meilleur . ', 'Nos activités sur la santé physique et mentale, l’information et la prévention.', ' <img src=\"img/caravan.png\" alt=\"\">', '2023-01-10', ' Caravanes Médicales');
...
CREATE TABLE IF NOT EXISTS `agenda` (
  ...
  `agendaText` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `agendaDetail` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
(1, 'Agenda', '0000-00-00', 'Slogan en long', 'Caravanes Médicales', '<img src=\"img/r.png\" alt=\"\">', '', 'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Repellendus quam nesciunt inventore libero excepturi facere sapiente, dolore, delectus nobis laudantium natus ', 'Détail');
...
INSERT INTO `contact` (`idContact`, `contactTitre`, `contactText`, `contactName`, `contactEmail`, `contactCategorie`, `contactMessage`, `contactButton`, `option1`, `option2`, `option3`, `option4`) VALUES
(1, 'Contactez-nous', 'Une envie de nous envoyer un message ?<br>\r\n Une question à nous poser ?<br> Un problème rencontré lors de votre visite ? <br> Veuillez utiliser ce formulaire pour prendre contact avec nous !<br>Je me ferai un plaisir de vous répondre dans les plus brefs délais .', 'Nom:', 'Mail :', 'Categorie :', 'Message :', 'Envoyer', 'Administration', 'Donation', 'Benevole', 'Autre');
...
(1, 'Nos Formations', '0000-00-00', 'L’émancipation économique par la voie de la formation', ' Education à la santé par la prévention', '  <img src=\"img/06.png\" alt=\"\">');
