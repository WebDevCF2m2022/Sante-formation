...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 08 sep. 2023 à 05:44
...
CREATE TABLE IF NOT EXISTS `action` (
  ...
  `actionImageText` longtext COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `agenda` (
  ...
  `agendaTitrelmage` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
