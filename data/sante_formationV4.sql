...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 10 juil. 2023 à 08:24
...
CREATE TABLE IF NOT EXISTS `asbl` (
  ...
  `titreSomme` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `textSomme` mediumtext COLLATE utf8mb4_general_ci NOT NULL,
  `descriptionSomme` longtext COLLATE utf8mb4_general_ci NOT NULL,
  `titreHistory` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `textHistory` mediumtext COLLATE utf8mb4_general_ci NOT NULL,
  `descriptionHistory` longtext COLLATE utf8mb4_general_ci NOT NULL,
  `titreObjectif` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `textObjectif` mediumtext COLLATE utf8mb4_general_ci NOT NULL,
  `descriptionObjectif` longtext COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`idasbl`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
