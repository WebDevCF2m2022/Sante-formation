...
CREATE TABLE IF NOT EXISTS `contactaccueil` (
  `idContactAccueil` int(11) NOT NULL AUTO_INCREMENT,
...
(3, 'Aide Alimentaire pour<br> 1 famille et 3 enfants', 'Communication: Aide Alimentaire pour 1 famille et 3 enfants', '50€/enfant', '<img src=\"img/famille.jpg\" alt=\"Aide Alimentaire pour 1 famille et 3 enfants\" id=\"photoDon\">', 'IBAN: BE32 7340 2599 5302', ''),
